...
acting on, offer one batched `AskUserQuestion` (multi-select) — an Other answer appends `user-correction-at-gate`, the rule `${CLAUDE_PLUGIN_ROOT}/references/ledger.md` owns — letting the user choose, per
finding, among:
