...
words are reachable only from a cell that measurably costs more per dispatch than its comparator. The compared cell has no floor — a thin one produces an interval that
